 ...
 */
class Tx_SfBooks_ViewHelpers_Widget_PaginateViewHelper extends Tx_Fluid_Core_Widget_AbstractWidgetViewHelper {
	/**
	 * @var Tx_SfBooks_ViewHelpers_Widget_Controller_PaginateController
	 */
	 ...
	 *
	 * @param Tx_SfBooks_ViewHelpers_Widget_Controller_PaginateController $controller
	 * @return void
	 */
	public function injectController(Tx_SfBooks_ViewHelpers_Widget_Controller_PaginateController $controller) {
